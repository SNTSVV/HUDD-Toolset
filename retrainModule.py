...
def fineTune(modelPath, outputPath, datasetName, epochNum, caseFile):
    if datasetName == "FLD":
        ...
        outputModel = join(modelsPath+"_finetuned.pt")
        outputLoss = join(modelsPath+"_fineTuned_loss.npy")
        ...
        if not isfile(trainSet):
            ...
            for i in range(6000, len(x_data)):
...
def testKP(testSet, outputModel, outputPath):
    ...
    testPredictor.predict(testDataSet, dst, None, False, outputTestCSV, 0, False, None)
